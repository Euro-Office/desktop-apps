...
This repo provides the **desktop application packaging** — Electron/native wrappers around the document editors for desktop deployment.

## Roadmap Items

### Phase 1 — Foundation

- [ ] Verify desktop editors can connect to a remote DocumentServer instance
- [ ] Test JWT authentication flow in desktop context
