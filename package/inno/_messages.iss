...
da.PrevVer=Der er fundet en tidligere version af {#sAppName}. Klik på 'OK' for at afinstallere den, eller på 'Annuller' for at afslutte installationen.
#if Ver >= EncodeVer(6,1,1)
...
da.InstallAdditionalComponents =Installerer yderligere systemkomponenter. Vent et øjeblik...
...
da.ErrorMismatchInstalledType =Den installerede version er lagt på med en anden type installer. Installer den rigtige pakke, eller afinstaller den eksisterende version, før du fortsætter.
;===============================================================================
...
da.ErrorMismatchInstalledArch =Arkitekturen i den installerede version passer ikke til denne pakke. Installer den rigtige pakke, eller afinstaller den eksisterende version, før du fortsætter.
;===============================================================================
...
da.ErrorMismatchInstalledEdition =Udgaven af den installerede version passer ikke til denne pakke. Installer den rigtige pakke, eller afinstaller den eksisterende version, før du fortsætter.
;===============================================================================
...
da.UpdateAppRunning=Installationen har registreret, at %1 kører i øjeblikket.%n%nDet lukkes automatisk. Klik på OK for at fortsætte.
...
da.WarningClearAppData =Vil du rydde brugerindstillingerne og appens cachede data?
...
da.UpdateService =Opdateringstjeneste til {#sAppName}
#if Ver >= EncodeVer(6,1,1)
...
da.AssociateDescription =Knyt kontordokumentets filtyper til {#ASSC_APP_NAME}
...
da.AssociateCaption =Filtilknytninger
...
da.AssociateSel =Tilknyt valgte
...
da.extMSExcel =Microsoft Excel-projektmappe
...
da.extODS =OpenDocument-regneark
...
da.extODP =OpenDocument-præsentation
...
da.extPPTM =Office Open XML-præsentation med makroer
#if Ver >= EncodeVer(6,1,1)
...
da.extDOTX =Office Open XML-dokumentskabelon
#if Ver >= EncodeVer(6,1,1)
...
da.extXLSB =Binært Excel-regneark
#if Ver >= EncodeVer(6,1,1)
...
da.extXLSM =Microsoft Excel-projektmappe med makroer
#if Ver >= EncodeVer(6,1,1)
...
da.extFODS =OpenDocument flad XML-regneark
#if Ver >= EncodeVer(6,1,1)
...
da.extFODT =OpenDocument flad XML-tekst
#if Ver >= EncodeVer(6,1,1)
...
da.defprogAppDescription=Gratis kontorpakke til skrivebordet til dokumentredigering og samarbejde
...
da.warnWin10FileAssociationDesc=Du skal åbne følgende vindue for at knytte filerne til programmet:
...
da.warnWin10FileAssociationPath=Indstillinger > Apps > Standardapps
...
da.runOpenDefaultApps=Åbn Standardapps
...
da.UninstallPageLabel=Tryk på Afinstaller for at fortsætte med afinstallationen.
...
da.UninstallOptionClearData=Slet alle brugerindstillinger og appens cachede data
