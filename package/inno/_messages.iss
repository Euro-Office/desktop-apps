...
en.EmptyLangDir =en-US
en_GB.EmptyLangDir =en-GB
ru.EmptyLangDir =ru-RU
de.EmptyLangDir =de-DE
fr.EmptyLangDir =fr-FR
es.EmptyLangDir =es-ES
sk.EmptyLangDir =sk-SK
cs.EmptyLangDir =cs-CZ
it_IT.EmptyLangDir =it-IT
pt_PT.EmptyLangDir =pt-PT
pt_BR.EmptyLangDir =pt-BR
pl.EmptyLangDir =pl-PL
zh_CN.EmptyLangDir =zh-CN
zh_TW.EmptyLangDir =zh-TW
ca.EmptyLangDir =ca-ES
da.EmptyLangDir =da-DK
el.EmptyLangDir =el-GR
;et.EmptyLangDir =default
fi.EmptyLangDir =fi-FI
;ga_IE.EmptyLangDir =ga-IE
he.EmptyLangDir =he-IL
;hi.EmptyLangDir =hi-IN
;hr.EmptyLangDir =hr-HR
hu.EmptyLangDir =hu-HU
hy_AM.EmptyLangDir =hy-AM
id.EmptyLangDir =id-ID
no.EmptyLangDir =nb-NO
ro.EmptyLangDir =ro-RO
sl.EmptyLangDir =sl-SI
sv.EmptyLangDir =sv-SE
tr.EmptyLangDir =tr-TR
ja.EmptyLangDir =ja-JP
ko.EmptyLangDir =ko-KR
bg.EmptyLangDir =bg-BG
nl.EmptyLangDir =nl-NL
vi.EmptyLangDir =vi-VN
lv.EmptyLangDir =lv-LV
;lt.EmptyLangDir =default
be.EmptyLangDir =default
uk.EmptyLangDir =uk-UA
lo.EmptyLangDir =lo-LA
gl.EmptyLangDir =gl-ES
si.EmptyLangDir =si-LK
ar_SA.EmptyLangDir =ar-SA
sr_Latn_RS.EmptyLangDir =sr-Latn-RS
sr_Cyrl_RS.EmptyLangDir =sr-Cyrl-RS
sq.EmptyLangDir =sq-AL
#if Ver >= EncodeVer(6,1,1)
ur.EmptyLangDir =ur-PK
#endif
...
;et.extXPS =XML paberispetsifikatsioon
;lt.extXPS =XML Popieriaus Specifikaciją
;hi.extXPS =ओपन एक्सएमएल पेपर विशिष्टता
;ga_IE.extXPS =Sonraíocht XML Paper
#if Ver >= EncodeVer(6,1,1)
#endif
...
;hi.extOXPS =ओपs एक्सएमएल पेपर विशिष्टता
